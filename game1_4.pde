...
int w1 = 30, h1 = 30, block1 = 20, direction1 = 0, foodx1 = 15, foody1 = 15,fc1=255, fc11= 255, fc111 = 255, speed = 8;
int[]x1_direction={0,0,1,-1}, y1_direction={1,-1,0,0};

ArrayList<Integer> x2 = new ArrayList<Integer>(), y2 = new ArrayList<Integer>();
int w2 = 30, h2 = 30, block2 = 20, direction2 = 0, foodx2 = 30, foody2 = 30, fc2=255, fc22= 255, fc222 = 255;
